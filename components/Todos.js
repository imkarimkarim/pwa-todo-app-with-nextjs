...
export default function Todos() {
  ...
  return (
    <div className='w-[90%] md:w-[50%] m-auto bottom-5 relative'>
      <div className='shadow-xl rounded-lg overflow-hidden'>
        <ul className='flex flex-col gap-[2px] bg-lightLgBlue/40 dark:bg-darkDgBlue/40'>
          {data.map((todo) => (
            <li
              key={todo.id}
              className='flex items-center px-3 py-4 bg-white dark:bg-darkVddBlue'>
              <span
              ...
              <p
                className={
                  todo.completed
                    ? 'pl-3 text-sm font-bold line-through text-lightLgBlue dark:text-darkDgBlue'
                    : 'pl-3 text-sm font-bold text-lightVdgBlue dark:text-darkLgBlue'
                }>
                {todo.content}
              </p>
              <img
          ...
          <li className='flex items-center px-5 py-4 bg-white dark:bg-darkVddBlue text-xs justify-between text-lightDgBlue font-bold'>
            ...
            <button
              className='dark:hover:text-darkLgBlue'
      ...
      <p className='text-lightDgBlue mt-10 w-[60%] m-auto'>
